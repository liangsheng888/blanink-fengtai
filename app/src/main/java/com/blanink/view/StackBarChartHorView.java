 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class StackBarChartHorView extends DemoView {
	...
	public StackBarChartHorView(Context context, AttributeSet attrs){
        super(context, attrs);   
        initView();
	 }
	 
	 public StackBarChartHorView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void chartLabels(List<String> chartLabels)
	{
