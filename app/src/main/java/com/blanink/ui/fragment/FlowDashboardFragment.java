...
import com.blanink.ui.activity.order.ComeOrderProductDetail;
import com.blanink.ui.activity.order.GoDownOrderProductDetail;
import com.blanink.ui.adapter.DashboardAdapter;
 ...
 */
public class FlowDashboardFragment extends Fragment {
    @BindView(R.id.lv)
    UpLoadListView lv;
    @BindView(R.id.srl)
    ...
    private String companyName="客户筛选";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position<currentRowsList.size()+1){
                    Intent intent = new Intent(getActivity(), ComeOrderProductDetail.class);
    ...
    private void loadDataRefresh() {
        ...
        RetrofitFactory.getApiService(getActivity())
                .listOrderProductJson(mapParams)
                ...
                .subscribe(new Observer<Dashboard>() {
                    ...
                    public void onNext(Dashboard dashboard) {
                        ...
                        if (dashboard.getResult().getRows().size() == 0) {
                            ...
                            currentRowsList.addAll(dashboard.getResult().getRows());
                            if (adapter == null) {
                                adapter = new DashboardAdapter(getActivity(),currentRowsList);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && resultCode == 200) {
            ...
            companyName=companyABean.getName();
