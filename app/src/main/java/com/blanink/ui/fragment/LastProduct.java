...
public class LastProduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = View.inflate(getActivity(), R.layout.fragment_company_product, null);
        }
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //   XUtilsImageUtils.displayLoading(viewHolder.iv_product_picture,BaseUrlUtils.NET_URL+rowList.get(position).productPhotos);
