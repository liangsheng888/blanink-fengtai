...
public class NextPartner extends Fragment {
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (customer.getCompanyA().getArea() != null) {
            ...
            if (partnerLists.get(position).getCompanyB().photo != null && !partnerLists.get(position).getCompanyB().photo.equals("")) {
                GlideUtils.glideImageView(getActivity(), viewHolder.iv, partnerLists.get(position).getCompanyB().photo, true);
            }
            return convertView;
        }
