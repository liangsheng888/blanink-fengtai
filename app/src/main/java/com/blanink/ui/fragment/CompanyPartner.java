 ...
 */
public class CompanyPartner extends Fragment {
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (sparseArray.get(position, null) == null) {
                ...
                viewHolder = (LastPartner.ViewHolder) convertView.getTag();
            }
            ...
            viewHolder.tv_customer_num.setText(customer.getCompanyA().serviceCount + "");
