...
import com.blanink.ui.adapter.CertificateAdapter;
...
public class LastHonest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = View.inflate(getActivity(), R.layout.layout_cmpany_honest, null);
        }
        //initView(view);
    ...
    private void initData() {
     /*   list = new ArrayList<>();
        ...
        adapter = new CertificateAdapter(getActivity(), list);
