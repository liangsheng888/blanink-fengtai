package com.blanink.ui.jshare.uitool;
...
public class ShareBoardConfig {
    ...
    public int mMenuBgShapeStrokeWidth;
    public int mMenuBgShapeStrokeColor;
    ...
    public  void setShareBoardlistener(ShareBoardlistener mShareBoardlistener) {
    ...
    public int calculateMenuHeightInDp(int menuSize) {
        byte itemHeight = 75;
        byte lineSpacing = 20;
