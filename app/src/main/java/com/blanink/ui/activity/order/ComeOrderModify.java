 ...
 * 编辑订单
 */
public class ComeOrderModify extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_come_order_modify);
    ...
    private void initData() {
        ...
        tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(ComeOrderModify.this, new DatePickerDialog.OnDateSetListener() {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(aOrderNumber)){
                    Toast.makeText(ComeOrderModify.this, "请填写订单编号", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(remarks)){
                    Toast.makeText(ComeOrderModify.this, "请填写备注", Toast.LENGTH_SHORT).show();
                    return;
                }
                DialogLoadUtils.getInstance(ComeOrderModify.this);
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ComeOrderModify.this, "服务器异常，请稍后再试", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onNext(Response response) {
                        if("00000".equals(response.getErrorCode())){
                            showNotify(ComeOrderModify.this,"修改订单成功");
                            DialogLoadUtils.dismissDialog();
                        }else {
                            DialogLoadUtils.dismissDialog();
                            Toast.makeText(ComeOrderModify.this, "修改失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<PartnerInfo>() {
                    ...
                    public void onNext(PartnerInfo partnerInfo) {
                        ...
                        if (partnerInfo.getResult().size() == 0) {
                            btnSave.setText("你没有客户，无法添加订单");
                            btnSave.setBackgroundColor(getResources().getColor(R.color.colorGray));
                        }
                        spCustomer.setAdapter(new ArrayAdapter<String>(ComeOrderModify.this, R.layout.spanner_item,customerNameList));
                        spCustomer.setSelection(getCustomerPosition(order.getACompany().getName()), true);
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<OfficeEmp>() {
                    ...
                    public void onNext(final OfficeEmp officeEmp) {
                        ...
                        spMaster.setAdapter(new ArrayAdapter<String>(ComeOrderModify.this, R.layout.spanner_item, masterNameList));
