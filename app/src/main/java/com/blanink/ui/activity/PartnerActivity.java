...
public class PartnerActivity extends BaseActivity {
    ...
    public void getPartner() {
        ...
        params.put("companyA.id", sp.getString("COMPANY_ID", null));
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<PartnerInfo>() {
                    ...
                    public void onNext(final PartnerInfo partnerInfo) {
                        ...
                        lv.setAdapter(new PartnerAdapter(PartnerActivity.this, partnerInfo.getResult(),"1"));
                        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                PartnerInfo.ResultBean pr = partnerInfo.getResult().get(position);
                                Intent intent = new Intent();
                                intent.putExtra("companyB", pr.getCompanyB());
