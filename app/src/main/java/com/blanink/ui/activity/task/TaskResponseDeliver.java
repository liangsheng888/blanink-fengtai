 ...
 * 发货 列表
 */
public class TaskResponseDeliver extends BaseActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //激光推送
            RetrofitFactory.getApiService(TaskResponseDeliver.this)
                    .deliver(paramsMap)
            ...
            DialogNotifyUtils.showNotifyDestroyActivity(TaskResponseDeliver.this, "继续", "返回", "发货成功");
        }
    };
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<FeedBackingTask>() {
                    ...
                    public void onNext(FeedBackingTask feedBackingTask) {
                        ...
                        if (feedBackingTask.getResult().getRelFlowProcess() != null) {
                        ...
                        spSender.setAdapter(new ArrayAdapter<String>(TaskResponseDeliver.this, R.layout.spanner_item, masterItem));
