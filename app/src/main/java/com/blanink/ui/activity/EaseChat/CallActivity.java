...
public class CallActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle arg0) {
        ...
        pushProvider = new EMCallManager.EMCallPushProvider() {
            ...
            public void onRemoteOffline(final String to) {
               ...
               Log.e(TAG, "onRemoteOffline, to:" + to);
                ...
                message.setMessageStatusCallback(new EMCallBack(){
                    ...
                    public void onSuccess() {
                       Log.e(TAG, "onRemoteOffline success");
                        updateMessageText(message, to);
                    }

                    @Override
                    public void onError(int code, String error) {
                       Log.e(TAG, "onRemoteOffline Error");
                        updateMessageText(message, to);
                    }
    ...
    protected Handler handler = new Handler(callHandlerThread.getLooper()) {
        ...
        public void handleMessage(Message msg) {
           Log.e(TAG, "handleMessage ---enter block--- msg.what:" + msg.what);
            switch (msg.what) {
...
//                        }
                   ...
                   Log.e(TAG, "answer call isInComingCall:false");
                }
                break;
            ...
            case MSG_CALL_END:
               ...
               Log.e("EMCallManager", "soundPool stop MSG_CALL_END");
                try {
           ...
           Log.e(TAG, "handleMessage ---exit block--- msg.what:" + msg.what);
        }
    };
