...
/***
 * 上家管理 客户管理 供应商邀请 我成为客户
 */
public class LastFamilyManageCustomerSupplierInvite extends BaseActivity {
    @BindView(R.id.title)
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_last_family_manage_customer_supplier_invite);
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<NotifyOffice>() {
                    ...
                    public void onNext(NotifyOffice office) {
                        ...
                        GlideUtils.glideImageView(LastFamilyManageCustomerSupplierInvite.this, iv, notifyOffice.getResult().getCompanyB().getPhoto(), true);
                        tvRemarks.setText(content);
                        tvMaster.setText(notifyOffice.getResult().getCompanyB().getMaster());
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_agree:
                //同意
                deleteNofity("同意后，双方将建立合作关系！请谨慎","取消","确定");
                break;
            case R.id.bt_refuse:
                //拒绝
                showNotify();
        ...
        view.findViewById(R.id.btn_send).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(message)) {
                    Toast.makeText(LastFamilyManageCustomerSupplierInvite.this, "请填写拒绝理由", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void reject() {
        ...
        mapParams.put("companyB.id", notifyOffice.getResult().getCompanyB().getId());
        mapParams.put("notify.content", message);
        mapParams.put("isApply", "0");
        RetrofitFactory.getApiService(this)
                .customerRemoveNo(mapParams)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<Response>() {
                    @Override
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(LastFamilyManageCustomerSupplierInvite.this, "服务器异常", Toast.LENGTH_SHORT).show();
                    ...
                    public void onNext(Response response) {
                        ...
                        if ("00000".equals(response.getErrorCode())) {
                            ...
                            params.put("office.id",notifyOffice.getResult().getCompanyB().getId());
                            params.put("flag","REJECT_CUSTOMER");

                            RetrofitFactory.getApiService(LastFamilyManageCustomerSupplierInvite.this)
                            ...
                            DialogNotifyUtils.showNotify(LastFamilyManageCustomerSupplierInvite.this, "你拒绝了对方的请求");
                        } else {
                            Toast.makeText(LastFamilyManageCustomerSupplierInvite.this, "操作失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    public void onNext(Response response) {
                        ...
                        if ("00000".equals(response.getErrorCode())) {
                            ...
                            params.put("currentUser.id",sp.getString("USER_ID", null));
                            params.put("office.id",notifyOffice.getResult().getCompanyB().getId());
                            params.put("flag","AGREE_CUSTOMER");
                            ...
                            DialogNotifyUtils.showNotify(LastFamilyManageCustomerSupplierInvite.this, "你同意了对方的请求");
                        } else {
                            Toast.makeText(LastFamilyManageCustomerSupplierInvite.this, "操作失败", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void deleteNofity( String content, String left, String right) {
        ...
        window.findViewById(R.id.tv_exit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogLoadUtils.getInstance(LastFamilyManageCustomerSupplierInvite.this);
                DialogLoadUtils.showDialogLoad("操作进行中...");
                agreeApply();
                alertDialog.dismiss();
            }
