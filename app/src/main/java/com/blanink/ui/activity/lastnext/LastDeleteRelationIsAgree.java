...
public class LastDeleteRelationIsAgree extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_last_delete_relation_is_agree);
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<NotifyOffice>() {
                    ...
                    public void onNext(NotifyOffice notifyOffice) {
                        ...
                        GlideUtils.glideImageView(LastDeleteRelationIsAgree.this, iv, notifyOffice.getResult().getCompanyB().getPhoto(), true);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_agree:
                //同意
                //提示
                deleteNofity("是否同意对方的请求?,请谨慎！", "取消", "确定");
    ...
    private void reject() {
        ...
        mapParams.put("companyB.id", office.getResult().getCompanyB().getId());
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    public void onNext(Response response) {
                        ...
                        if ("00000".equals(response.getErrorCode())) {
                            ...
                            params.put("office.id", office.getResult().getCompanyB().getId());
                            params.put("flag", "REJECT_DEL_CUSTOMER");

                            RetrofitFactory.getApiService(LastDeleteRelationIsAgree.this)
                                    ...
                                    .subscribe(new Observer<ResponseDelete>() {
                                        ...
                                        public void onError(Throwable e) {
                                            alertDialog.dismiss();
                                            DialogLoadUtils.dismissDialog();
                                            Toast.makeText(LastDeleteRelationIsAgree.this, "服务器异常", Toast.LENGTH_SHORT).show();
                                        }
                            ...
                            DialogNotifyUtils.showNotify(LastDeleteRelationIsAgree.this, "你拒绝对方的解除请求");
                        } else {
                            Toast.makeText(LastDeleteRelationIsAgree.this, "操作失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    public void onNext(Response response) {
                        ...
                        if ("00000".equals(response.getErrorCode())) {
                            ...
                            params.put("currentUser.id", sp.getString("USER_ID", null));
                            params.put("office.id", office.getResult().getCompanyB().getId());
                            params.put("flag", "AGREE_DEL_CUSTOMER");
                            ...
                            DialogNotifyUtils.showNotify(LastDeleteRelationIsAgree.this, "你同意了对方的解除请求");
                            finish();
                        } else {
                            Toast.makeText(LastDeleteRelationIsAgree.this, "操作失败", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void deleteNofity(String content, String left, String right) {
        ...
        window.findViewById(R.id.tv_exit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogLoadUtils.getInstance(LastDeleteRelationIsAgree.this);
                DialogLoadUtils.showDialogLoad("操作进行中...");
                agreeApply();
                alertDialog.dismiss();
            }
