...
public class DashBoardResponseDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dash_board_response_detail);
                    ...
                    public void onItemClick(View view, int position) {
                        if (photoAdapter.getItemViewType(position) == PhotoAdapter.TYPE_ADD) {
                            PhotoPicker.builder()
                                    ...
                                    .start(DashBoardResponseDetailActivity.this);
                        } else {
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    public void onNext(Response response) {
                        if (response.getErrorCode().equals("00000")) {
                            ...
                            Toast.makeText(DashBoardResponseDetailActivity.this, "反馈失败", Toast.LENGTH_SHORT).show();
                            DialogLoadUtils.dismissDialog();
                        }
                    }
                });
    ...
    private void showDialog() {
        final AlertDialog alertDialog = new AlertDialog.Builder(DashBoardResponseDetailActivity.this).create();
        alertDialog.show();
        ...
        RetrofitFactory.getApiService(this)
                ...
                .subscribe(new Observer<FeedBackingTask>() {
                    ...
                    public void onNext(final FeedBackingTask feedbackingTask) {
                        ...
                        if (feedbackingTask.getResult().getCompanyA() != null && feedbackingTask.getResult().getCompanyA().getName() != null) {
                        ...
                        if (feedbackingTask.getResult().getCompanyCategory() != null && feedbackingTask.getResult().getCompanyCategory().getName() != null) {
                            ...
                            //显示反馈记录
                            lvResponseNote.setAdapter(new CommonAdapter<FeedBackingTask.ResultBean.ProcessFeedbackListBean>(DashBoardResponseDetailActivity.this, feedbackingTask.getResult().getProcessFeedbackList(), R.layout.item_history_note_response, 4) {
                                @Override
