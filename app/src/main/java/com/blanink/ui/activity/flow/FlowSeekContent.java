...
public class FlowSeekContent extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flow_seek_content);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position < rowsList.size()) {
                    Intent intent = new Intent(FlowSeekContent.this, FlowProduct.class);
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (sparseArray.get(position, null) == null) {
                ...
                convertView = View.inflate(FlowSeekContent.this, R.layout.item_go_comeorder, null);
            ...
            GlideUtils.glideImageView(FlowSeekContent.this,viewHolder.iv_log,order.getACompany().getPhoto(),true);
